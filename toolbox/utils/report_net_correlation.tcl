...
proc ::tb::utils::report_net_correlation::GetNetCorrelation { args } {
  ...
  $tbl header [list {Design} {Part} {Path #} {Driver Tile} {Receiver Tile} {Driver Site} {Receiver Site} {Driver Pin} {Receiver Pin} {Path Slack} {Routable Nets} {Driver Incr Delay} {Net Incr Delay} {Delay Type} {Estimated Delay} {P2P Delay} {Estimated vs. P2P} {Error vs. P2P (%)} {Absolute Error (ns)} {Fanout} {Tiles Distance (X+Y)} {SLR Crossing} {Driver INT} {Receiver INT} {Net} {Driver} {Receiver}  ]
