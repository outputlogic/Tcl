...
#   set output [concat $output [split [$tbl print] \n] ]
  ...
  ##
  ########################################################################################
  # Example of run directory: /proj/rdi-xco/fisusr/no_backup/ABELite/Results/US_CUSTOMER_2016.4/tarana_FCB_TOP_bc2_2016_07_11/TEST_WORK_us_cust_def_rel_20161028_213754_lnx64
  set dir [file split [pwd]]
  # E.g: US_CUSTOMER_2016.4
  set suite [lindex $dir end-2]
  # E.g: tarana_FCB_TOP_bc2_2016_07_11
  set design [lindex $dir end-1]
  set csvrow [list]
  if {$SPRITE_INTEGRATION} {
    lappend csvrow $suite
    lappend csvrow $design
  }
...
# Call ilself when integrated inside SPRITE suites
if {$::tb::utils::report_failfast::SPRITE_INTEGRATION} {
