...
interp alias {} reload {} insert_buffer.tcl

proc a {net} {
  set ::tclapp::xilinx::designutils::insert_buffer::debug 0
  set loads [::tclapp::xilinx::designutils::insert_buffer::getNetSegmentLoadPins $net]
  set drivers [::tclapp::xilinx::designutils::insert_buffer::getNetSegmentDriverPins $net]
  foreach pin $drivers {
    puts "driver: $pin"
  }
  foreach pin $loads {
