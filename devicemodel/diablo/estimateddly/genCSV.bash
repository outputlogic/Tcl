...
echo '"Design","Part","Path #","Driver Tile","Receiver Tile","Driver Site","Receiver Site","Driver Pin","Receiver Pin","Path Slack","Levels","Routable Nets","Driver Incr Delay","Net Incr Delay","Delay Type","Estimated Delay","P2P Delay","Estimated vs. P2P","Error vs. P2P (%)","Absolute Error (ns)","Net vs. Estimated","Net vs. P2P","Fanout","Tiles Distance (X+Y)","SLR Crossing","Driver INT","Receiver INT","Net","Driver","Receiver"' > net_corr_setup.csv
...
echo '"Design","Part","Path #","Driver Tile","Receiver Tile","Driver Site","Receiver Site","Driver Pin","Receiver Pin","Path Slack","Levels","Routable Nets","Driver Incr Delay","Net Incr Delay","Delay Type","Estimated Delay","P2P Delay","Estimated vs. P2P","Error vs. P2P (%)","Absolute Error (ns)","Net vs. Estimated","Net vs. P2P","Fanout","Tiles Distance (X+Y)","SLR Crossing","Driver INT","Receiver INT","Net","Driver","Receiver"' > net_corr_hold.csv
